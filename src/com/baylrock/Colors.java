...
public enum Colors {
    ...
    /**
     * @apiNote stepSize == 1 -> heap OutOfMemory  (8g heap needed), final file size 451mb
     */
    public static void doCacheFullMap( int stepSize ) {
    ...
    public static Colors getColors( Color undefined ) {
        double distance = Double.MAX_VALUE;
        double buffDistance;
        Colors buf = null;
        for (Colors color : values()) {
            buffDistance = color.distanceTo( undefined );
